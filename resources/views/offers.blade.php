<!-------------------------------------------------------------------------------------
    ...
    Note: This is Our Offers (Catalouge) Page.
--------------------------------------------------------------------------------------->

@include('layout-all')

    <!--====== Title ======-->
    <title> {{$page_name}} • Locus Hotel Our Offers </title>
    <!--====== OFF CANVAS START ======-->
    ...
    <section class="offers-area pt-120 pb-60">
        <div class="container">
            <div class="offer-boxes-loop">
                <div class="offer-box">
                    <div class="thumb">
                        <img src="assets/img/offers/01.jpg" alt="images">
                    </div>
                ...
                <div class="offer-box">
                    <div class="thumb">
                        <img src="assets/img/offers/02.jpg" alt="images">
                    </div>
                    <div class="offer-desc">
                        <div class="title-wrap">
                            <div class="title">
                ...
                <div class="offer-box">
                    <div class="thumb">
                        <img src="assets/img/offers/03.jpg" alt="images">
                    </div>
                    <div class="offer-desc">
                        <div class="title-wrap">
                            <div class="title">
                ...
                <div class="offer-box">
                    <div class="thumb">
                        <img src="assets/img/offers/04.jpg" alt="images">
                    </div>
                    <div class="offer-desc">
                        <div class="title-wrap">
                            <div class="title">
    ...
    <!--====== FEATURE ROOM START ======-->
    <section class="feature-room-section with-bg pt-155 pb-115" style="background-image: url(assets/img/bg/06.jpg);">
        <div class="container">
