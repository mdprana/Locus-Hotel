<!-------------------------------------------------------------------------------------
    ...
    Note: This is Main Places Page.
--------------------------------------------------------------------------------------->

@include('layout-all')

    <!--====== Title ======-->
    <title> {{$page_name}} • Locus Hotel Our Places </title>
    <!--====== OFF CANVAS START ======-->
    ...
    <section class="breadcrumb-area" style="background-image: url(assets/img/bg/04.jpg);">
        <div class="container">
            <div class="breadcrumb-text">
                ...
                <h2 class="page-title">Nearest Places</h2>
            ...
            <div class="places-boxes pt-115">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-10">
                        <div class="place-box mt-30">
                            <div class="place-bg-wrap">
                                <div class="place-bg" style="background-image: url(assets/img/places/05.jpg);"></div>
                            </div>
                            <div class="desc">
                                <h4><a href="{{ url('places-details') }}">Duplex Restaurant</a></h4>
                                <span class="time">1,500m | 21 min. Walk</span>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-10">
                        <div class="place-box mt-30">
                            <div class="place-bg-wrap">
                                <div class="place-bg" style="background-image: url(assets/img/places/06.jpg);"></div>
                            </div>
                            <div class="desc">
                                <h4><a href="{{ url('places-details') }}">Duplex Restaurant</a></h4>
                                <span class="time">1,500m | 21 min. Walk</span>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-10">
                        <div class="place-box mt-30">
                            <div class="place-bg-wrap">
                                <div class="place-bg" style="background-image: url(assets/img/places/07.jpg);"></div>
                            </div>
                            <div class="desc">
                                <h4><a href="{{ url('places-details') }}">Duplex Restaurant</a></h4>
                                <span class="time">1,500m | 21 min. Walk</span>
